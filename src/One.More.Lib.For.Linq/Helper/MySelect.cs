...
public static partial class LinqHelper
{
    ...
    public static IEnumerable<U> MySelect<T, U>(this IEnumerable<T> source, Func<T, int, U> selector)
    {
        int index = 0;
        foreach (var item in source)
    ...
    public static IEnumerable<U> MySelectThrowEarly<T, U>(this IEnumerable<T> source, Func<T, U> selector)
    {
